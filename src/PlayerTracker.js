...
PlayerTracker.prototype.getScale = function() {
    this.massChanged && this.updateMass();
    return this._scale;
};
...
PlayerTracker.prototype.joinGame = function(name, skin) {
    ...
    this.spectating = 0;
    this.freeRoam = 0;
    if (!this.isMi && this.socket.connected != null) {
...
PlayerTracker.prototype.updateTick = function() {
    ...
    var w = (viewBaseX / scale) / 2;
    var h = (viewBaseY / scale) / 2;
...
PlayerTracker.prototype.pressQ = function() {
    if (this.spectating) {
        ...
        if (tick - this.lastQTick < 25) return;
        this.lastQTick = tick;
